...
if(UNIX)
    ...
    set(OPENSSL_DEP_LIBSSL_PATH "${OPENSSL_DEP_LIB_DIR}/libssl.so")
elseif(WIN32)
    set(OPENSSL_DEP_LIB_DIR "${OPENSSL_DEP_ROOT_DIR}/bin")
    set(OPENSSL_DEP_LIBCRYPTO_PATH "${OPENSSL_DEP_LIB_DIR}/libcrypto-3-x64.dll")
    set(OPENSSL_DEP_LIBSSL_PATH "${OPENSSL_DEP_LIB_DIR}/libssl-3-x64.dll")
endif()
